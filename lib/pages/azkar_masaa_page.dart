...
class AzkarMasaaPage extends StatefulWidget {
  @override
  _AzkarMasaaPageState createState() => _AzkarMasaaPageState();
}

class _AzkarMasaaPageState extends State<AzkarMasaaPage> {
              ...
              children: <Widget>[
                Container(
                  ...
                  child: FutureBuilder(
                    ...
                    future: DefaultAssetBundle.of(context).loadString('assets/json/azkar-masaa.json'),),
                ),
              ],
            ),
          ),
